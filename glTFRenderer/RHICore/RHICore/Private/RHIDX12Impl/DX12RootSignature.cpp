...
bool DX12StaticSampler::InitStaticSampler(IRHIDevice& device, unsigned space, REGISTER_INDEX_TYPE registerIndex, RHIStaticSamplerAddressMode addressMode, RHIStaticSamplerFilterMode filterMode)
{
    m_description.RegisterSpace = space;
...
bool DX12StaticSampler::Release(IRHIMemoryManager& memory_manager)
{
    return true;
}
...
bool DX12RootSignature::Release(IRHIMemoryManager& memory_manager)
{
