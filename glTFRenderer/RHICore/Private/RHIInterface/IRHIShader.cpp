...
glTFShaderUtils::ShaderType glTFShaderUtils::GetShaderType(RHIShaderType type)
{
    switch (type) 
    {
        case RHIShaderType::Vertex: return glTFShaderUtils::ShaderType::ST_Vertex;
        case RHIShaderType::Pixel: return glTFShaderUtils::ShaderType::ST_Fragment;
        case RHIShaderType::Compute: return glTFShaderUtils::ShaderType::ST_Compute;
    }
    return glTFShaderUtils::ShaderType::ST_Undefined;
}
