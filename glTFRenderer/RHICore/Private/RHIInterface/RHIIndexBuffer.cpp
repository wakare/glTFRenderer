    ...
    const IndexBufferData& index_buffer_data)
{
    ...
    memory_manager.UploadBufferData(device, command_list, *m_upload_buffer, index_buffer_data.data.get(), 0, index_buffer_data.byte_size);
...
RHIDataFormat RHIIndexBuffer::GetFormat() const
{
    return m_index_format;
}

size_t RHIIndexBuffer::GetCount() const
{
    return m_index_count;
}

IRHIBuffer& RHIIndexBuffer::GetBuffer() const
{
