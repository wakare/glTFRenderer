...
class DemoAppModelViewerFrostedGlass : public DemoAppModelViewer
{
public:
    IMPL_NON_COPYABLE_AND_DEFAULT_CTOR_VDTOR(DemoAppModelViewerFrostedGlass)
...
protected:
    ...
    virtual const char* GetSnapshotTypeName() const override { return "DemoAppModelViewerFrostedGlass"; }
    ...
    struct FrostedGlassStateSnapshot final : ModelViewerStateSnapshot
    {
        bool enable_panel_input_state_machine{true};
        bool enable_frosted_prepass_feeds{true};
        unsigned blur_source_mode{0};
        bool full_fog_mode{false};
