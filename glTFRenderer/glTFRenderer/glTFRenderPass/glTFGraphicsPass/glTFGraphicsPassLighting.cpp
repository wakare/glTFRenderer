...
bool glTFGraphicsPassLighting::PreRenderPass(glTFRenderResourceManager& resource_manager)
{
    ...
    BindDescriptor(command_list, m_albedo_allocation, *m_base_pass_albedo_allocation);
    BindDescriptor(command_list, m_depth_allocation, *m_depth_texture_allocation);
    BindDescriptor(command_list, m_normal_allocation, *m_base_pass_normal_allocation);
