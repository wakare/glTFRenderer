...
bool glTFRayTracingPassWithMesh::AddOrUpdatePrimitiveToMeshPass(glTFRenderResourceManager& resource_manager,
    ...
    const glTFSceneObjectBase& object)
{
    ...
    return AddOrUpdatePrimitiveToMeshPass(resource_manager, *primitive) &&
        primitive->HasMaterial() && ProcessMaterial(resource_manager, primitive->GetMaterial());
}
