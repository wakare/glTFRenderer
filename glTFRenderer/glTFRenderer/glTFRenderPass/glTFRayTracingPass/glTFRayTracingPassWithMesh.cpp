...
bool glTFRayTracingPassWithMesh::PreRenderPass(glTFRenderResourceManager& resource_manager)
{
    ...
    BindDescriptor(resource_manager.GetCommandListForRecord(), m_raytracing_as_allocation.space, m_raytracing_as_allocation.global_parameter_index, m_raytracing_as->GetTLASDescriptorSRV());
