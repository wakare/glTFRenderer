...
bool glTFComputePassLighting::PreRenderPass(glTFRenderResourceManager& resource_manager)
{
    ...
    BindDescriptor(command_list, m_albedo_allocation.space, m_albedo_allocation.global_parameter_index, *m_base_color_SRV);
    BindDescriptor(command_list, m_depth_allocation.space, m_depth_allocation.global_parameter_index, *m_depth_SRV);
    BindDescriptor(command_list, m_normal_allocation.space, m_normal_allocation.global_parameter_index, *m_normal_SRV);
    BindDescriptor(command_list, m_output_allocation.space, m_output_allocation.global_parameter_index, *m_output_UAV);
