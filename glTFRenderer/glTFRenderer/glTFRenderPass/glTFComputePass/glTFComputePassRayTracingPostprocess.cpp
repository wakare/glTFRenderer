...
bool glTFComputePassRayTracingPostprocess::PreRenderPass(glTFRenderResourceManager& resource_manager)
{
    ...
    BindDescriptor(command_list, m_process_input_allocation.space, m_process_input_allocation.global_parameter_index, *m_post_process_input_handle);
    ...
    BindDescriptor(command_list, m_process_output_allocation.space, m_process_output_allocation.global_parameter_index, *m_post_process_output_handle);
