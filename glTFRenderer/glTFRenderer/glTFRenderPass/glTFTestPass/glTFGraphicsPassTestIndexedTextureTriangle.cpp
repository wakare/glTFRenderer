...
bool glTFGraphicsPassTestIndexedTextureTriangle::SetupRootSignature(glTFRenderResourceManager& resource_manager)
{
    ...
    RETURN_IF_FALSE(m_root_signature_helper.AddTableRootParameter("SAMPLED_TEX_REGISTER_INDEX", {RHIDescriptorRangeType::SRV, 1, false, false}, m_sampled_texture_root_signature_allocation))
