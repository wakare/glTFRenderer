...
namespace glTFRenderResourceUtils
{
    ...
    {
        auto& GBufferPassResource = GetGBufferPassResource(pass_id);
        updater.BindDescriptor(command_list, pipeline_type, allocation.m_albedo_allocation.space, allocation.m_albedo_allocation.global_parameter_index, *GBufferPassResource.m_albedo_handle);
        updater.BindDescriptor(command_list, pipeline_type, allocation.m_normal_allocation.space, allocation.m_normal_allocation.global_parameter_index, *GBufferPassResource.m_normal_handle);
        updater.BindDescriptor(command_list, pipeline_type, allocation.m_depth_allocation.space, allocation.m_depth_allocation.global_parameter_index, *GBufferPassResource.m_depth_handle);
        ...
        IRHIDescriptorUpdater& updater)
    {
        ...
        updater.BindDescriptor(command_list, pipeline_type, m_writable_buffer_allocation.space, m_writable_buffer_allocation.global_parameter_index, *m_writable_buffer_handle);
        updater.BindDescriptor(command_list, pipeline_type, m_back_buffer_allocation.space, m_back_buffer_allocation.global_parameter_index, *m_back_buffer_handle);
