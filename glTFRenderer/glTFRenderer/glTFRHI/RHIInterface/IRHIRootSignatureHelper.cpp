...
bool IRHIRootSignatureHelper::AddRootParameterWithRegisterCount(const std::string& parameter_name, RHIRootParameterType type,
    unsigned register_count, unsigned constant_value, RHIRootParameterDescriptorRangeType table_type, RootSignatureAllocation& out_allocation)
{
...
{
    return AddRootParameterWithRegisterCount(parameter_name, RHIRootParameterType::Constant, 1, constant_value, RHIRootParameterDescriptorRangeType::Unknown, out_allocation);
}

bool IRHIRootSignatureHelper::AddCBVRootParameter(const std::string& parameter_name, RootSignatureAllocation& out_allocation)
{
    return AddRootParameterWithRegisterCount(parameter_name, RHIRootParameterType::CBV, 1, 0, RHIRootParameterDescriptorRangeType::Unknown, out_allocation);
}

bool IRHIRootSignatureHelper::AddSRVRootParameter(const std::string& parameter_name, RootSignatureAllocation& out_allocation)
{
    return AddRootParameterWithRegisterCount(parameter_name, RHIRootParameterType::SRV, 1, 0, RHIRootParameterDescriptorRangeType::Unknown, out_allocation);
}

bool IRHIRootSignatureHelper::AddUAVRootParameter(const std::string& parameter_name, RootSignatureAllocation& out_allocation)
{
    return AddRootParameterWithRegisterCount(parameter_name, RHIRootParameterType::UAV, 1, 0, RHIRootParameterDescriptorRangeType::Unknown, out_allocation);
}

bool IRHIRootSignatureHelper::AddTableRootParameter(const std::string& parameter_name,
    RHIRootParameterDescriptorRangeType table_type, unsigned table_register_count, RootSignatureAllocation& out_allocation)
{
    return AddRootParameterWithRegisterCount(parameter_name, RHIRootParameterType::DescriptorTable, table_register_count, 0, table_type, out_allocation);
}
