...
public:
    ...
    virtual bool CreateUnOrderAccessViewInDescriptorHeap(IRHIDevice& device, IRHIRenderTarget& renderTarget, const RHIShaderResourceViewDesc& desc, /*output*/ RHIGPUDescriptorHandle& outGPUHandle) = 0;
};
