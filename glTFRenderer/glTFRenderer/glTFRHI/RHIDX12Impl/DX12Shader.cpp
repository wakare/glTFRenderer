...
bool DX12Shader::CompileShaderWithDXC()
{
    ...
    auto file_path = to_wide_string(m_shader_file_path);
    auto target = to_wide_string(GetShaderCompilerTarget());
    ...
    LPCWSTR pszArgs[] =
    {
        file_path.c_str(),            // Optional shader source file name for error reporting and for PIX shader source view.  
