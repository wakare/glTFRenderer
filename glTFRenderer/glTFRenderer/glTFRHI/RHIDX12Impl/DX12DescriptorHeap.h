...
private:
    ...
    bool CreateRTVInHeap(IRHIDevice& device, unsigned descriptor_offset, ID3D12Resource* resource, const RHIShaderResourceViewDesc& desc, /*output*/ RHICPUDescriptorHandle& out_CPU_handle);
    bool CreateDSVInHeap(IRHIDevice& device, unsigned descriptor_offset, ID3D12Resource* resource, const RHIShaderResourceViewDesc& desc, /*output*/ RHICPUDescriptorHandle& out_CPU_handle);
