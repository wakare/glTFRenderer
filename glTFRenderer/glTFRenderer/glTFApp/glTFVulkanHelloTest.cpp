...
void glTFVulkanHelloTest::RecordCommandBuffer(VkCommandBuffer command_buffer, unsigned image_index)
{
...
void glTFVulkanHelloTest::DrawFrame()
{
...
void glTFVulkanHelloTest::CreateSwapChainAndRelativeResource()
{
    const QueueFamilyIndices queue_family_indices = FindQueueFamily(select_physical_device, surface);
    GLTF_CHECK(queue_family_indices.graphics_family.has_value());
...
void glTFVulkanHelloTest::CleanupSwapChain()
{
...
void glTFVulkanHelloTest::RecreateSwapChain()
{
...
bool glTFVulkanHelloTest::Update()
{
    DrawFrame();
    return true;
}

bool glTFVulkanHelloTest::UnInit()
{
    vkDeviceWaitIdle(logical_device);
