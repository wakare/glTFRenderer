...
{
    ShaderHandle result{_internal_handle++};
...
{
    RenderTargetHandle result{_internal_handle++};
...
{
    RenderPassHandle result{_internal_handle++};
...
{
    IndexedBufferHandle result{_internal_handle++};
...
{
    TextureHandle result{_internal_handle++};
